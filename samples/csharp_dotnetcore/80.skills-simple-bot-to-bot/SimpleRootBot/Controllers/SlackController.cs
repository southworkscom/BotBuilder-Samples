...
namespace Microsoft.BotBuilderSamples.SimpleRootBot.Controllers
{
    ...
    public class SlackController : ControllerBase
    {
        ...
        //
        //public async Task<IActionResult> ReplyToActivityAsync(string conversationId, string activityId, [FromBody] Activity activity)
        //{
        //    var result = await _adapter.ProcessAsync
        //}
    }
}
